...
// _worker.js
var F = /* @__PURE__ */ __name((e, t, r) => (s, n) => {
  let i = -1;
  return a(0);
  async function a(l) {
...
var he = /* @__PURE__ */ __name(async (e, t = /* @__PURE__ */ Object.create(null)) => {
...
var ye = /* @__PURE__ */ __name((e) => L(e, decodeURI), "ye");
...
var _ = /* @__PURE__ */ __name((e, t, ...r) => (r.length && (t = _(t, ...r)), `${e?.[0] === "/" ? "" : "/"}${e}${t === "/" ? "" : `${e?.at(-1) === "/" ? "" : "/"}${t?.[0] === "/" ? t.slice(1) : t}`}`), "_");
...
var $ = /* @__PURE__ */ __name((e) => /[%+]/.test(e) ? (e.indexOf("+") !== -1 && (e = e.replace(/\+/g, " ")), e.indexOf("%") !== -1 ? L(e, z) : e) : e, "$");
var V = /* @__PURE__ */ __name((e, t, r) => {
  let s;
  if (!r && t && !/[%+]/.test(t)) {
    let a = e.indexOf("?", 8);
    if (a === -1) return;
...
var Re = V;
var be = /* @__PURE__ */ __name((e, t) => V(e, t, true), "be");
var z = decodeURIComponent;
var q = /* @__PURE__ */ __name((e) => L(e, z), "q");
var Q = class {
  static {
    __name(this, "Q");
  }
...
var xe = { Stringify: 1 };
var X = /* @__PURE__ */ __name(async (e, t, r, s, n) => {
...
var M = /* @__PURE__ */ __name((e, t) => ({ "Content-Type": e, ...t }), "M");
var Oe = class {
  static {
    __name(this, "Oe");
  }
  ...
  setLayout = /* @__PURE__ */ __name((e) => this.#h = e, "setLayout");
  getLayout = /* @__PURE__ */ __name(() => this.#h, "getLayout");
  setRenderer = /* @__PURE__ */ __name((e) => {
    this.#c = e;
  }, "setRenderer");
  header = /* @__PURE__ */ __name((e, t, r) => {
  ...
  get = /* @__PURE__ */ __name((e) => this.#r ? this.#r.get(e) : void 0, "get");
  get var() {
  ...
  body = /* @__PURE__ */ __name((e, t, r) => this.#a(e, t, r), "body");
  text = /* @__PURE__ */ __name((e, t, r) => !this.#o && !this.#i && !t && !r && !this.finalized ? new Response(e) : this.#a(e, t, M(_e, r)), "text");
  json = /* @__PURE__ */ __name((e, t, r) => this.#a(JSON.stringify(e), t, M("application/json", r)), "json");
  html = /* @__PURE__ */ __name((e, t, r) => {
    const s = /* @__PURE__ */ __name((n) => this.#a(n, t, M("text/html; charset=UTF-8", r)), "s");
  ...
  notFound = /* @__PURE__ */ __name(() => (this.#l ??= () => new Response(), this.#l(this)), "notFound");
};
var p = "ALL";
var Ae = "all";
...
var Pe = /* @__PURE__ */ __name((e) => e.text("404 Not Found", 404), "Pe");
...
var Ce = class Z {
  ...
  route(t, r) {
    ...
    return r.routes.map((n) => {
      let i;
      r.errorHandler === B ? i = n.handler : (i = /* @__PURE__ */ __name(async (a, l) => (await F([], r.errorHandler)(a, () => n.handler(a, l))).res, "i"), i[Se] = n.handler), s.#i(n.method, n.path, i);
    }), this;
  }
  basePath(t) {
    const r = this.#e();
  ...
  fetch = /* @__PURE__ */ __name((t, ...r) => this.#s(t, r[1], r[0], t.method), "fetch");
  request = /* @__PURE__ */ __name((t, r, s, n) => t instanceof Request ? this.fetch(r ? new Request(t, r) : t, s, n) : (t = t.toString(), this.fetch(new Request(/^https?:\/\//.test(t) ? t : `http://localhost${_("/", t)}`, r), s, n)), "request");
...
var v = new ne();
v.use("/api/*", We());
var A = /* @__PURE__ */ __name(async (e, t) => {
...
// ../.wrangler/tmp/bundle-8pT7mN/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-8pT7mN/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.8704842810918971.mjs.map
